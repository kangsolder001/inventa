                        ...
                        <div class="card shadow mb-4">
                             <div class="card-header py-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="kelola3.php" type="button" class="btn btn-outline-primary mb-3">
                          ...
                          <table class="table align-middle table-bordered table-hover">
                            ...
                            ?>
                              <tr>
                                ...
                                <td>
                                    <a href="kelola3.php?ubah=<?php echo $result['id']; ?>" type="button" class="btn btn-outline-success btn-sm">
                                        <i class="fa fa-pen" aria-hidden="true"></i></a>
                                        
                                    <a href="proses3.php?hapus=<?php echo $result['id']; ?>" type="button" class="btn btn-outline-danger btn-sm" onClick="return confirm('Anda Yakin Ingin Menghapus?')">

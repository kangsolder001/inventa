...
<body id="page-top">
   ...
   <?php include'menu.php';?>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Data Barang Kamar Lantai 2</h1>
              ...
              <div class="container">
                <form method="POST" action="proses2.php" enctype="form-data">
                    <input type="hidden" value="<?php echo $id; ?>" name="id">
              <div class="mb-3 row">
                    <label for="Kamar" class="col-sm-2 col-form-label">Kamar</label>
                <div class="col-sm-10">
                      <input type="text" name="Kamar" class="form-control" id="Kamar" placeholder="ex:DN 2.2" value="<?php echo $Kamar; ?>">
                </div>
                </div>
                <div class="mb-3 row">
              ...
              <div class="mb-3 row mt-4">
                <div class="col">
                    ...
                    ?>
                <a href="lantai2.php"type="button" class="btn btn-danger">
